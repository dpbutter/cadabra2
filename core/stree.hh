...
class Nodemap {
    ...
    */
    ...
    public:
        ...
        void build();
        void add_subtree(iterator);
        void remove_subtree(iterator);
...
void Nodemap<T, tree_node_allocator>::build() 
    ...
    map_.clear();
    add_subtree(tr_ptr_->begin());
    }


// Add a subtree to the nodemap
template <class T, class tree_node_allocator>
void Nodemap<T, tree_node_allocator>::add_subtree(iterator start) {
    ...
    int node_depth = tr_ptr_->depth(it);
...
template <class T, class tree_node_allocator>
void Nodemap<T, tree_node_allocator>::remove_subtree(iterator start) {
    // start begins at root node of the subtree
    typename tree<T, tree_node_allocator>::post_order_iterator it = start;
...
template <class T, class tree_node_allocator>
Nodemap<T, tree_node_allocator>::node_sets_t Nodemap<T, tree_node_allocator>::find_pattern(tree<T, tree_node_allocator>& pattern) {
...
template <class T, class tree_node_allocator>
Nodemap<T, tree_node_allocator>::node_set_t Nodemap<T, tree_node_allocator>::map_nodes_to_parents_(node_set_t child_nodes) {
