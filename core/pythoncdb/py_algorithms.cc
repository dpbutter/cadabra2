...
namespace cadabra {
	...
	void init_algorithms(py::module& m)
		...
		def_algo<sort_product, unsigned int>(m, "sort_product", true, false, 0, py::arg("algochoice") = 0);
		...
		def_algo<substitute, Ex, bool, bool>(m, "substitute", true, false, 0, py::arg("rules"), py::arg("partial") = true, py::arg("skip_checks") = false);
